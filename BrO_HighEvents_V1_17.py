...
Traj_E1_2 = pd.concat(Traj)

#-------------
# Back Trajectories (EVENT 3 & 4)
#-------------
# Set the location for the working directory
os.chdir("/Users/ncp532/Documents/Data/SeaIce_Trajectories/100m/")
...
# Back Trajectories ( EVENT 1 & 2)
#-------------
Traj_E1_2['year']     = Traj_E1_2['Traj Year']
Traj_E1_2['month']    = Traj_E1_2['Traj Mon']
Traj_E1_2['day']      = Traj_E1_2['Traj Day']
Traj_E1_2['hour']     = Traj_E1_2['Traj Hour']
Traj_E1_2['minute']   = Traj_E1_2['Traj Min']
Traj_E1_2['DateTime'] = pd.to_datetime(Traj_E1_2[['year', 'month', 'day', 'hour', 'minute']])
Traj_E1_2.index       = (pd.to_datetime(Traj_E1_2['DateTime']) + timedelta(hours=7)) # Davis timezone is UT+7

#-------------
# Back Trajectories ( EVENT 3 & 4)
#-------------
Traj_E3_4['year']     = Traj_E3_4['Traj Year']
Traj_E3_4['month']    = Traj_E3_4['Traj Mon']
Traj_E3_4['day']      = Traj_E3_4['Traj Day']
Traj_E3_4['hour']     = Traj_E3_4['Traj Hour']
Traj_E3_4['minute']   = Traj_E3_4['Traj Min']
Traj_E3_4['DateTime'] = pd.to_datetime(Traj_E3_4[['year', 'month', 'day', 'hour', 'minute']])
Traj_E3_4.index       = (pd.to_datetime(Traj_E3_4['DateTime']) + timedelta(hours=7)) # Davis timezone is UT+7
...
# Back Trajectories ( EVENT 6 & 7)
#-------------
Traj_E6_7['year']     = Traj_E6_7['Traj Year']
Traj_E6_7['month']    = Traj_E6_7['Traj Mon']
Traj_E6_7['day']      = Traj_E6_7['Traj Day']
Traj_E6_7['hour']     = Traj_E6_7['Traj Hour']
Traj_E6_7['minute']   = Traj_E6_7['Traj Min']
Traj_E6_7['DateTime'] = pd.to_datetime(Traj_E6_7[['year', 'month', 'day', 'hour', 'minute']])
Traj_E6_7.index       = (pd.to_datetime(Traj_E6_7['DateTime']) + timedelta(hours=7)) # Davis timezone is UT+7
...
#------------------------------------------------------------------------------
# PLOT EVENT 1 & 2 (14 November 2017)
#------------------------------------------------------------------------------
...
ax.scatter(Traj_E1_2['Traj Lon'], Traj_E1_2['Traj Lat'], zorder=2, cmap=cmap, transform=data_crs, marker='o', s=1, norm=norm, c=Traj_E1_2['IceContact_100m'], label='Traj Height (m)')
...
cs1 = ax.scatter(Traj_E1_2['Traj Age'], Traj_E1_2['Traj Height (m)'], marker='o', s=1, cmap=cmap, norm=norm, c=Traj_E1_2['IceContact_100m'], label='Traj Height (m)')
ax.plot(Traj_E1_2['Traj Age'][0], Traj_E1_2['Traj Height (m)'][0], color='k', marker='*')
...
#------------------------------------------------------------------------------
# PLOT EVENT 3 & 4 (15 November 2017)
#------------------------------------------------------------------------------
fig = plt.figure(figsize=(10,6))
...
#ax.scatter(Traj['Traj Lon'], Traj['Traj Lat'], zorder=2, cmap=cmap, transform=data_crs, marker='o', s=1, norm=norm, c=Traj['Traj Age'], label='Traj Height (m)')
ax.scatter(Traj_E3_4['Traj Lon'], Traj_E3_4['Traj Lat'], zorder=2, cmap=cmap, transform=data_crs, marker='o', s=1, norm=norm, c=Traj_E3_4['IceContact_100m'], label='Traj Height (m)')
...
#cs1 = ax.scatter(Traj['Traj Age'], Traj['Traj Height (m)'], marker='o', s=1, cmap=cmap, norm=norm, c=Traj['Traj Age'], label='Traj Height (m)')
cs1 = ax.scatter(Traj_E3_4['Traj Age'], Traj_E3_4['Traj Height (m)'], marker='o', s=1, cmap=cmap, norm=norm, c=Traj_E3_4['IceContact_100m'], label='Traj Height (m)')
ax.plot(Traj_E3_4['Traj Age'][0], Traj_E3_4['Traj Height (m)'][0], color='k', marker='*')
...
#------------------------------------------------------------------------------
# PLOT EVENT 6 & 7 (20 November 2017)
#------------------------------------------------------------------------------
fig = plt.figure(figsize=(10,6))
...
#ax.scatter(Traj['Traj Lon'], Traj['Traj Lat'], zorder=2, cmap=cmap, transform=data_crs, marker='o', s=1, norm=norm, c=Traj['Traj Age'], label='Traj Height (m)')
ax.scatter(Traj_E6_7['Traj Lon'], Traj_E6_7['Traj Lat'], zorder=2, cmap=cmap, transform=data_crs, marker='o', s=1, norm=norm, c=Traj_E6_7['IceContact_100m'], label='Traj Height (m)')
...
#cs1 = ax.scatter(Traj['Traj Age'], Traj['Traj Height (m)'], marker='o', s=1, cmap=cmap, norm=norm, c=Traj['Traj Age'], label='Traj Height (m)')
cs1 = ax.scatter(Traj_E6_7['Traj Age'], Traj_E6_7['Traj Height (m)'], marker='o', s=1, cmap=cmap, norm=norm, c=Traj_E6_7['IceContact_100m'], label='Traj Height (m)')
ax.plot(Traj_E6_7['Traj Age'][0], Traj_E6_7['Traj Height (m)'][0], color='k', marker='*')
...
#------------------------------------------------------------------------------
# PLOT A-Priori investigation (23 November 2017)
#------------------------------------------------------------------------------
fig = plt.figure(figsize=(10,6))
fig.suptitle('23 November 2017', fontsize=20, y=0.95)
gs = fig.add_gridspec(4, 3)
plt.subplots_adjust(wspace=0.05)
...
# Plot Start/Finish time for high BrO event
start  = ax.axvline(datetime(2017,11,23,4,50,0),  linewidth=1.0, color='r')
finish = ax.axvline(datetime(2017,11,23,10,50,0), linewidth=1.0, color='r')

# Text box for Start/Finish
props = dict(boxstyle='round', facecolor='white', alpha=1.0)
ax3.text(datetime(2017,11,23,4,50,0),  113, "Start",  color='r', fontsize=10, verticalalignment='top', horizontalalignment='center', bbox=props)
ax3.text(datetime(2017,11,23,10,50,0), 113, "Finish", color='r', fontsize=10, verticalalignment='top', horizontalalignment='center', bbox=props)
...
ax = fig.add_subplot(gs[0:3,-1]) # options graph 1 (vertical no, horizontal no, graph no)
...
#------------------------------------------------------------------------------
# PLOT A priori investigation (24 November 2017)
#------------------------------------------------------------------------------
fig = plt.figure(figsize=(10,6))
fig.suptitle('24 November 2017', fontsize=20, y=0.95)
gs = fig.add_gridspec(4, 3)
plt.subplots_adjust(wspace=0.05)
...
# Plot Start/Finish time for high BrO event
start  = ax.axvline(datetime(2017,11,24,4,50,0),  linewidth=1.0, color='r')
finish = ax.axvline(datetime(2017,11,24,10,50,0), linewidth=1.0, color='r')

# Text box for Start/Finish
props = dict(boxstyle='round', facecolor='white', alpha=1.0)
ax3.text(datetime(2017,11,24,4,50,0),  113, "Start",  color='r', fontsize=10, verticalalignment='top', horizontalalignment='center', bbox=props)
ax3.text(datetime(2017,11,24,10,50,0), 113, "Finish", color='r', fontsize=10, verticalalignment='top', horizontalalignment='center', bbox=props)

# Format x-axis
plt.xlim(datetime(2017,11,24,0,0,0),datetime(2017,11,24,23,59,59))
xmajor_formatter = mdates.DateFormatter('%H:%M') # format how the date is displayed
ax.xaxis.set_major_formatter(xmajor_formatter)
ax.xaxis.set_major_locator(mdates.HourLocator(interval=3)) # set the interval between dispalyed dates
ax.xaxis.set_minor_locator(mdates.HourLocator(interval=1))
