...
Temp_s_SIPEXII         = np.array(D4_SIPEXII['TEMP_AIR_STRBRD_DEGC'])                           # starboard side temperature
Temp_p_SIPEXII         = np.array(D4_SIPEXII['TEMP_AIR_PORT_DEGC'])                             # port side temperature
D4_SIPEXII['Temp_Avg'] = D4_SIPEXII[['TEMP_AIR_STRBRD_DEGC','TEMP_AIR_PORT_DEGC']].mean(axis=1) # Average the temperature for port and starboard
Temp_SIPEXII           = np.array(D4_SIPEXII['Temp_Avg'])
...
# Low Wind Speed (<7 m/s)
#-----------------------------
SIPEXIIF1L  = (D4_SIPEXIIL['Sea_Ice_Conc'] >= 0.3)
D4_SIPEXIIL = D4_SIPEXIIL[SIPEXIIF1L]

#-----------------------------
# High Wind Speed (>=7 m/s)
#-----------------------------
SIPEXIIF1H  = (D4_SIPEXIIH['Sea_Ice_Conc'] >= 0.3)
D4_SIPEXIIH = D4_SIPEXIIH[SIPEXIIF1H]
...
# Low Wind Speed (<7 m/s)
#-----------------------------
SIPEXIIF1L  = (D4_SIPEXIIL['Temp_Avg'] < -10)
D4_SIPEXIIL = D4_SIPEXIIL[SIPEXIIF1L]

#-----------------------------
# High Wind Speed (>=7 m/s)
#-----------------------------
SIPEXIIF1H  = (D4_SIPEXIIH['Temp_Avg'] < -10)
D4_SIPEXIIH = D4_SIPEXIIH[SIPEXIIF1H]
...
# Surface Layer 
D4_SIPEXIIL[0.1] = D4_SIPEXIIL[0.1] * 1e6 # convert from ppmv to ppbv
BrO_SIPEXIILS     = np.array(D4_SIPEXIIL[0.1])

# Boundary Layer 
D4_SIPEXIIL[0.3]  = D4_SIPEXIIL[0.3] * 1e6 # convert from ppmv to ppbv
BrO_SIPEXIILB     = np.array(D4_SIPEXIIL[0.3])
...
D4_SIPEXIIL['WND_SPD_STRBD_CORR_KNOT'] = D4_SIPEXIIL['WND_SPD_STRBD_CORR_KNOT'] * 0.514444444                           # Convert from knots to m/s
WS_s_SIPEXIIL                          = np.array(D4_SIPEXIIL['WND_SPD_STRBD_CORR_KNOT'])

D4_SIPEXIIL['WND_SPD_PORT_CORR_KNOT']  = D4_SIPEXIIL['WND_SPD_PORT_CORR_KNOT']  * 0.514444444                           # Convert from knots to m/s
WS_p_SIPEXIIL                          = np.array(D4_SIPEXIIL['WND_SPD_PORT_CORR_KNOT'])

D4_SIPEXIIL['MeanWS']                  = D4_SIPEXIIL[['WND_SPD_STRBD_CORR_KNOT','WND_SPD_PORT_CORR_KNOT']].mean(axis=1) # Average the wind speed for port and starboard
WS_SIPEXIIL                            = np.array(D4_SIPEXIIL['MeanWS'])

#--------------------------------
# Vector Mean Wind Direction

D4_SIPEXIIL['WD_vect'] = ((WD_s_SIPEXIIL * WS_s_SIPEXIIL) / (WS_s_SIPEXIIL + WS_p_SIPEXIIL)) + ((WD_p_SIPEXIIL * WS_p_SIPEXIIL) / (WS_s_SIPEXIIL + WS_p_SIPEXIIL)) # Calculate the vector mean wind direction
WD_vect_SIPEXIIL       = np.array(D4_SIPEXIIL['WD_vect'])
...
D4_SIPEXIIL['Sea_Ice_Conc'] = D4_SIPEXIIL['Sea_Ice_Conc'] * 100
SI_SIPEXIIL                 = np.array(D4_SIPEXIIL['Sea_Ice_Conc'])
#--------------------------------
# Relative Humidity
...
D4_SIPEXIIL['MeanRH'] = D4_SIPEXIIL[['REL_HUMIDITY_STRBRD_PERCENT','REL_HUMIDITY_PORT_PERCENT']].mean(axis=1) # Average the relative humidity for port and starboard
RH_SIPEXIIL           = np.array(D4_SIPEXIIL['MeanRH'])
...
# Surface Layer 
D4_SIPEXIIH[0.1] = D4_SIPEXIIH[0.1] * 1e6 # convert from ppmv to ppbv
BrO_SIPEXIIHS     = np.array(D4_SIPEXIIH[0.1])

# Boundary Layer 
D4_SIPEXIIH[0.3]  = D4_SIPEXIIH[0.3] * 1e6 # convert from ppmv to ppbv
BrO_SIPEXIIHB     = np.array(D4_SIPEXIIH[0.3])
...
D4_SIPEXIIH['WND_SPD_STRBD_CORR_KNOT'] = D4_SIPEXIIH['WND_SPD_STRBD_CORR_KNOT'] * 0.514444444                           # Convert from knots to m/s
WS_s_SIPEXIIH                          = np.array(D4_SIPEXIIH['WND_SPD_STRBD_CORR_KNOT'])

D4_SIPEXIIH['WND_SPD_PORT_CORR_KNOT']  = D4_SIPEXIIH['WND_SPD_PORT_CORR_KNOT']  * 0.514444444                           # Convert from knots to m/s
WS_p_SIPEXIIH                          = np.array(D4_SIPEXIIH['WND_SPD_PORT_CORR_KNOT'])

D4_SIPEXIIH['MeanWS']                  = D4_SIPEXIIH[['WND_SPD_STRBD_CORR_KNOT','WND_SPD_PORT_CORR_KNOT']].mean(axis=1) # Average the wind speed for port and starboard
WS_SIPEXIIH                            = np.array(D4_SIPEXIIH['MeanWS'])

#--------------------------------
# Vector Mean Wind Direction

D4_SIPEXIIH['WD_vect'] = ((WD_s_SIPEXIIH * WS_s_SIPEXIIH) / (WS_s_SIPEXIIH + WS_p_SIPEXIIH)) + ((WD_p_SIPEXIIH * WS_p_SIPEXIIH) / (WS_s_SIPEXIIH + WS_p_SIPEXIIH)) # Calculate the vector mean wind direction
WD_vect_SIPEXIIH       = np.array(D4_SIPEXIIH['WD_vect'])
...
D4_SIPEXIIH['Sea_Ice_Conc'] = D4_SIPEXIIH['Sea_Ice_Conc'] * 100
SI_SIPEXIIH                 = np.array(D4_SIPEXIIH['Sea_Ice_Conc'])
...
D4_SIPEXIIH['MeanRH'] = D4_SIPEXIIH[['REL_HUMIDITY_STRBRD_PERCENT','REL_HUMIDITY_PORT_PERCENT']].mean(axis=1) # Average the relative humidity for port and starboard
RH_SIPEXIIH           = np.array(D4_SIPEXIIH['MeanRH'])
...
MLR = mlr.fit(D4_SIPEXIIH[['Sea_Ice_Conc','MeanRH']],D4_SIPEXIIH['MeanTemp'])
