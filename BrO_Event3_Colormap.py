...
V3_2017_18 = pd.read_csv('/Users/ncp532/Documents/Data/V1_17_APriori/V3_17/all_BrO/all_BrO_vmr_prof_20180201.dat', sep='\s+', index_col=0) # BrO data for CAMPCANN V3 (2017/18)
...
d0 = datetime(2018,2,1,0,10,0)
end = datetime(2018,2,1,23,59,59)
...
plt.title('BrO VCD (1 Feb 2018)', fontsize=25)
