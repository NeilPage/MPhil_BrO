...
# NO2 VMR
NO2 = pd.read_csv('/Users/ncp532/Documents/data/V1_17_APriori/V3_17/all_NO2/V3_17_NO2_VMR.csv',index_col=0) # NO2 data for CAMPCANN V3 (2017/18)

# NO2 Error
NO2_Error = pd.read_csv('/Users/ncp532/Documents/data/V1_17_APriori/V3_17/NO2_error/V3_17_NO2_error.csv', index_col=0) # NO2 error data for CAMPCANN V3 (2017/18)
...
# BrO AOD
BrO_AOD = pd.read_csv('/Users/ncp532/Documents/data/V1_17_APriori/V3_17/all_AOD/V3_17_AOD_338.csv',index_col=0) # AOD data for CAMPCANN V3 (2017/19)

# NO2_AOD
NO2_AOD = pd.read_csv('/Users/ncp532/Documents/data/V1_17_APriori/V3_17/all_AOD/V3_17_AOD_375.csv',index_col=0) # AOD data for CAMPCANN V3 (2017/18)

#---------
# SZA
#---------

DF4_SZA = pd.read_csv('/Users/ncp532/Documents/data/V1_17_APriori/V3_17/all_SZA/V3_17_SZA.csv',index_col=0) # SZA data for CAMPCANN V3 (2017/18)
...
# Filtered
y = V3_17T.index # set the values for the y-axis
x = np.array(V3_17T.dtypes.index) # set the values for the x-axis
z = V3_17T.copy() # identify the matrix containing the z-values (BrO in ppMv)
...
plt.xlim(datetime(2018,2,1,0,0,0),datetime(2018,2,18,0,0,5))
...
# #plt.title('CAMMPCAN V3 2017-18 NO$_2$ VMR', fontsize=25)
# plt.xlim(datetime(2018,2,1,0,0,0),datetime(2018,2,18,0,0,5))
