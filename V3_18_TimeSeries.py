...
# BrO Data
V3_BrO = pd.read_csv('/Users/ncp532/Documents/Data/CAMMPCAN_2018_19/TG_Retrieval_V3/V3_BrO_QAQC.csv')

# NO2 Data
V3_NO2 = pd.read_csv('/Users/ncp532/Documents/Data/CAMMPCAN_2018_19/TG_Retrieval_V3/V3_NO2_QAQC.csv')

# O3 Data
V3_O3 = pd.read_csv('/Users/ncp532/Documents/Data/CAMMPCAN_2018_19/O3/V3_O3_1min.csv')

# Met data
V3_Met = pd.read_csv('/Users/ncp532/Documents/Data/CAMMPCAN_2018_19/V03/CAMMPCAN_V3_underway_60.csv') 

# Hg Data
V3_Hg = pd.read_csv('/Users/ncp532/Documents/Data/CAMMPCAN_2018_19/CAMMPCAN_V3_Hg0_Lat_Long_18-19.csv')
...
plt.xlim(datetime(2019,1,9),datetime(2019,3,1)) # all dates
...
plt.title('Time series for V3 (CAMMPCAN 2018-19)', fontsize=25, y=1.2)
