...
#---------
# BrO VMR
BrO_V1_17 = pd.read_csv('/Users/ncp532/Documents/data/V1_17_APriori/V2_18/all_BrO/V2_18_BrO_VMR.csv', index_col=0) # BrO data for CAMPCANN V1 (2018/19)

# BrO Error
Err_V1_17 = pd.read_csv('/Users/ncp532/Documents/data/V1_17_APriori/V2_18/BrO_error/V2_18_BrO_error.csv', index_col=0) # BrO error data for CAMPCANN V1 (2018/19)
...
#---------
AEC_V1_17 = pd.read_csv('/Users/ncp532/Documents/data/V1_17_APriori/V2_18/all_Aerosol/V2_18_AeroExt_338.csv',index_col=0) # Aerosol extinction data at 338 nm for CAMPCANN V1 (2017/18)

#---------
# AOD
#---------
AOD_V1_17 = pd.read_csv('/Users/ncp532/Documents/data/V1_17_APriori/V2_18/all_AOD/V2_18_AOD_338.csv',index_col=0) # AOD data for CAMMPCAN V1 (2018/19)

#---------
# SZA
#---------
SZA_V1_17 = pd.read_csv('/Users/ncp532/Documents/data/V1_17_APriori/V2_18/all_SZA/V2_18_SZA.csv',index_col=0) # SZA data for CAMPCANN V1 (2018/19)

#---------
# MET
#---------
Met_V1_17  = pd.read_csv('/Users/ncp532/Documents/Data/CAMMPCAN_2018_19/ShipTrack/V2_18_underway_60.csv', index_col=0)

#---------
# O3
#---------
O3_V1_17   = pd.read_csv('/Users/ncp532/Documents/Data/CAMMPCAN_2018_19/O3/V2_O3_1min.csv', index_col=0)

#---------
# Hg0
#---------
Hg0_V1_17 = pd.read_csv('/Users/ncp532/Documents/Data/CAMMPCAN_2018_19/CAMMPCAN_V2_Hg0_QAQC_18-19.csv', index_col=0)
...
# XARRAY
cubes_E18a = xr.open_dataset('/Users/ncp532/Documents/Data/Sea_Ice_Cover/Hamburg_ICDC/20181220_median5day.nc', decode_cf=False, engine='netcdf4')
cubes_E19a = xr.open_dataset('/Users/ncp532/Documents/Data/Sea_Ice_Cover/Hamburg_ICDC/20181226_median5day.nc', decode_cf=False, engine='netcdf4')

cubes_E18b = xr.open_dataset('/Users/ncp532/Documents/Data/Sea_Ice_Cover/NSIDC/2018-19/seaice_conc_daily_icdr_sh_f18_20181220_v01r00.nc', decode_cf=False, engine='netcdf4')
cubes_E19b = xr.open_dataset('/Users/ncp532/Documents/Data/Sea_Ice_Cover/NSIDC/2018-19/seaice_conc_daily_icdr_sh_f18_20181226_v01r00.nc', decode_cf=False, engine='netcdf4')

#-------------
# Back Trajectories ( EVENT 18)
#-------------
...
Traj_E18 = pd.concat(Traj)

#-------------
# Back Trajectories ( EVENT 19)
#-------------
# Set the location for the working directory
os.chdir("/Users/ncp532/Documents/Data/SeaIce_Trajectories/100m/")
...
# Back Trajectories ( EVENT 18)
#-------------
Traj_E18['year']     = Traj_E18['Traj Year']
Traj_E18['month']    = Traj_E18['Traj Mon']
Traj_E18['day']      = Traj_E18['Traj Day']
Traj_E18['hour']     = Traj_E18['Traj Hour']
Traj_E18['minute']   = Traj_E18['Traj Min']
Traj_E18['DateTime'] = pd.to_datetime(Traj_E18[['year', 'month', 'day', 'hour', 'minute']])
Traj_E18.index       = (pd.to_datetime(Traj_E18['DateTime']) + timedelta(hours=8)) # Davis timezone is UT+7

#-------------
# Back Trajectories ( EVENT 19)
#-------------
Traj_E19['year']     = Traj_E19['Traj Year']
Traj_E19['month']    = Traj_E19['Traj Mon']
Traj_E19['day']      = Traj_E19['Traj Day']
Traj_E19['hour']     = Traj_E19['Traj Hour']
Traj_E19['minute']   = Traj_E19['Traj Min']
Traj_E19['DateTime'] = pd.to_datetime(Traj_E19[['year', 'month', 'day', 'hour', 'minute']])
Traj_E19.index       = (pd.to_datetime(Traj_E19['DateTime']) + timedelta(hours=8)) # Davis timezone is UT+7
...
# Event 18 (20 Dec 2018)
start_date = '2018-12-20'
end_date   = '2018-12-21'
Event18    = (SIPEXIITT.index >= start_date) & (SIPEXIITT.index < end_date)
Event18M   = SIPEXIITT[Event18]

# Event 19 (26 Dec 2018)
start_date = '2018-12-26'
end_date   = '2018-12-27'
Event19    = (SIPEXIITT.index >= start_date) & (SIPEXIITT.index < end_date)
Event19M   = SIPEXIITT[Event19]

# Transpose the dataframes back again
Event18TT  = Event18M.T
Event19TT  = Event19M.T
...
#HAMBURG
seaice_data_E18a = cubes_E18a.variables['sea_ice_area_fraction'][0,:,:] # Sea Ice concentration (time,y,x)(1,664,632)
lats_E18a        = cubes_E18a.latitude
lons_E18a        = cubes_E18a.longitude

seaice_data_E19a = cubes_E19a.variables['sea_ice_area_fraction'][0,:,:] # Sea Ice concentration (time,y,x)(1,664,632)
lats_E19a        = cubes_E19a.latitude
lons_E19a        = cubes_E19a.longitude
...
# Event 18
Mean_Event18   = np.mean(Event18TT, axis=1) * 1e6
Median_Event18 = np.nanmedian(Event18TT, axis=1) * 1e6
StDev_Event18  = np.std(Event18TT, axis=1) * 1e6
MAD_Event18    = Event18TT.mad(axis=1, skipna='True') * 1e6
MAX_Event18    = np.max(Event18TT, axis=1) * 1e6
MIN_Event18    = np.min(Event18TT, axis=1) * 1e6

# Event 19
Mean_Event19   = np.mean(Event19TT, axis=1) * 1e6
Median_Event19 = np.nanmedian(Event19TT, axis=1) * 1e6
StDev_Event19  = np.std(Event19TT, axis=1) * 1e6
MAD_Event19    = Event19TT.mad(axis=1, skipna='True') * 1e6
MAX_Event19    = np.max(Event19TT, axis=1) * 1e6
MIN_Event19    = np.min(Event19TT, axis=1) * 1e6

#------------------------------------------------------------------------------
# PLOT EVENT 18 (20 December 2018)
#------------------------------------------------------------------------------
fig = plt.figure(figsize=(10,6))
fig.suptitle('20 December 2018', fontsize=20, y=0.95)
...
start  = ax.axvline(datetime(2018,12,20,9,50,0),  linewidth=1.0, color='r')
finish = ax.axvline(datetime(2018,12,20,13,50,0), linewidth=1.0, color='r')

# Text box for Start/Finish
props = dict(boxstyle='round', facecolor='white', alpha=1.0)
ax3.text(datetime(2018,12,20,9,50,0),  113, "Start",  color='r', fontsize=10, verticalalignment='top', horizontalalignment='center', bbox=props)
ax3.text(datetime(2018,12,20,13,50,0), 113, "Finish", color='r', fontsize=10, verticalalignment='top', horizontalalignment='center', bbox=props)

# Format x-axis
plt.xlim(datetime(2018,12,20,0,0,0),datetime(2018,12,20,23,59,59))
...
Line_Med = ax.errorbar(Median_Event18, MAX_Event18.index,   marker='o', c='blue',  markersize = 3.0, ls='-', xerr=MAD_Event18, capsize=2)
Line_Ran = ax.fill_betweenx(MAX_Event18.index, MAX_Event18, MIN_Event18, facecolor='blue', alpha=0.3, interpolate=False) # fill the distribution
Star_Max = ax.scatter(8.8, 0.7, c ='black', marker='*')
...
seaice_data_E18a = np.ma.masked_where(seaice_data_E18a==0,seaice_data_E18a)
#cmap=cm.get_cmap('viridis')
cmap=cmocean.cm.ice
cmap.set_bad(color='lightgrey')
cs = ax.pcolormesh(lons_E18a, lats_E18a, seaice_data_E18a, transform=data_crs, cmap=cmap) #, bins=np.arange(0,100, 10))
...
ax.scatter(Traj_E18['Traj Lon'], Traj_E18['Traj Lat'], zorder=2, cmap=cmap, transform=data_crs, marker='o', s=1, norm=norm, c=Traj_E18['IceContact_100m'], label='Traj Height (m)')
...
cs1 = ax.scatter(Traj_E18['Traj Age'], Traj_E18['Traj Height (m)'], marker='o', s=1, cmap=cmap, norm=norm, c=Traj_E18['IceContact_100m'], label='Traj Height (m)')
ax.plot(Traj_E18['Traj Age'][0], Traj_E18['Traj Height (m)'][0], color='k', marker='*')
...
#------------------------------------------------------------------------------
# PLOT EVENT 19 (26 December 2018)
#------------------------------------------------------------------------------
fig = plt.figure(figsize=(10,6))
fig.suptitle('26 December 2018', fontsize=20, y=0.95)
gs = fig.add_gridspec(4, 3)
plt.subplots_adjust(wspace=0.05)
...
# Plot Start/Finish time for high BrO event
start  = ax.axvline(datetime(2018,12,26,11,30,0), linewidth=1.0, color='r')
finish = ax.axvline(datetime(2018,12,26,16,50,0), linewidth=1.0, color='r')

# Text box for Start/Finish
props = dict(boxstyle='round', facecolor='white', alpha=1.0)
ax3.text(datetime(2018,12,26,11,30,0), 113, "Start",  color='r', fontsize=10, verticalalignment='top', horizontalalignment='center', bbox=props)
ax3.text(datetime(2018,12,26,16,50,0), 113, "Finish", color='r', fontsize=10, verticalalignment='top', horizontalalignment='center', bbox=props)

# Format x-axis
plt.xlim(datetime(2018,12,26,0,0,0),datetime(2018,12,26,23,59,59))
xmajor_formatter = mdates.DateFormatter('%H:%M') # format how the date is displayed
ax.xaxis.set_major_formatter(xmajor_formatter)
ax.xaxis.set_major_locator(mdates.HourLocator(interval=3)) # set the interval between dispalyed dates
ax.xaxis.set_minor_locator(mdates.HourLocator(interval=1))
...
# Plot BrO MAX vertical profile
#ax.errorbar(MAX_Event10, MAX_Event10.index,   marker='o', c='black',  markersize = 3.0, ls='-', label ='Max BrO: 7.7 $\pm$ 1.6 pptv',   xerr=StDev_Event10,   capsize=2)
Line_Med = ax.errorbar(Median_Event19, MAX_Event19.index,   marker='o', c='blue',  markersize = 3.0, ls='-', xerr=MAD_Event19, capsize=2)
Line_Ran = ax.fill_betweenx(MAX_Event19.index, MAX_Event19, MIN_Event19, facecolor='blue', alpha=0.3, interpolate=False) # fill the distribution
...
# PLOT THE DATA (SEA ICE CONCENTRATION) 
seaice_data_E19a = np.ma.masked_where(seaice_data_E19a==0,seaice_data_E18a)
#cmap=cm.get_cmap('viridis')
cmap=cmocean.cm.ice
cmap.set_bad(color='lightgrey')
cs = ax.pcolormesh(lons_E19a, lats_E19a, seaice_data_E19a, transform=data_crs, cmap=cmap) #, bins=np.arange(0,100, 10))
#cs = ax.pcolormesh(lons, lats, seaice_data, transform=data_crs, cmap=cmocean.cm.ice) #, bins=np.arange(0,100, 10))
...
#ax.scatter(Traj['Traj Lon'], Traj['Traj Lat'], zorder=2, cmap=cmap, transform=data_crs, marker='o', s=1, norm=norm, c=Traj['Traj Age'], label='Traj Height (m)')
ax.scatter(Traj_E19['Traj Lon'], Traj_E19['Traj Lat'], zorder=2, cmap=cmap, transform=data_crs, marker='o', s=1, norm=norm, c=Traj_E19['IceContact_100m'], label='Traj Height (m)')
...
#cs1 = ax.scatter(Traj['Traj Age'], Traj['Traj Height (m)'], marker='o', s=1, cmap=cmap, norm=norm, c=Traj['Traj Age'], label='Traj Height (m)')
cs1 = ax.scatter(Traj_E19['Traj Age'], Traj_E19['Traj Height (m)'], marker='o', s=1, cmap=cmap, norm=norm, c=Traj_E19['IceContact_100m'], label='Traj Height (m)')
ax.plot(Traj_E19['Traj Age'][0], Traj_E19['Traj Height (m)'][0], color='k', marker='*')
