...
#------------------------------------------------------------------------------
# Calculate the Temperature (C) average

Temp_s_V1_17         = np.array(D4_V1_17['TEMP_AIR_STRBRD_DEGC'])                           # starboard side temperature
Temp_p_V1_17         = np.array(D4_V1_17['TEMP_AIR_PORT_DEGC'])                             # port side temperature
D4_V1_17['Temp_Avg'] = D4_V1_17[['TEMP_AIR_STRBRD_DEGC','TEMP_AIR_PORT_DEGC']].mean(axis=1) # Average the temperature for port and starboard
Temp_V1_17           = np.array(D4_V1_17['Temp_Avg'])

Temp_s_V2_17         = np.array(D4_V2_17['TEMP_AIR_STRBRD_DEGC'])                           # starboard side temperature
Temp_p_V2_17         = np.array(D4_V2_17['TEMP_AIR_PORT_DEGC'])                             # port side temperature
D4_V2_17['Temp_Avg'] = D4_V2_17[['TEMP_AIR_STRBRD_DEGC','TEMP_AIR_PORT_DEGC']].mean(axis=1) # Average the temperature for port and starboard
Temp_V2_17           = np.array(D4_V2_17['Temp_Avg'])

Temp_s_V3_17         = np.array(D4_V3_17['TEMP_AIR_STRBRD_DEGC'])                           # starboard side temperature
Temp_p_V3_17         = np.array(D4_V3_17['TEMP_AIR_PORT_DEGC'])                             # port side temperature
D4_V3_17['Temp_Avg'] = D4_V3_17[['TEMP_AIR_STRBRD_DEGC','TEMP_AIR_PORT_DEGC']].mean(axis=1) # Average the temperature for port and starboard
Temp_V3_17           = np.array(D4_V3_17['Temp_Avg'])

Temp_s_V1_18         = np.array(D4_V1_18['TEMP_AIR_STRBRD_DEGC'])                           # starboard side temperature
Temp_p_V1_18         = np.array(D4_V1_18['TEMP_AIR_PORT_DEGC'])                             # port side temperature
D4_V1_18['Temp_Avg'] = D4_V1_18[['TEMP_AIR_STRBRD_DEGC','TEMP_AIR_PORT_DEGC']].mean(axis=1) # Average the temperature for port and starboard
Temp_V1_18           = np.array(D4_V1_18['Temp_Avg'])

Temp_s_V2_18         = np.array(D4_V2_18['TEMP_AIR_STRBRD_DEGC'])                           # starboard side temperature
Temp_p_V2_18         = np.array(D4_V2_18['TEMP_AIR_PORT_DEGC'])                             # port side temperature
D4_V2_18['Temp_Avg'] = D4_V2_18[['TEMP_AIR_STRBRD_DEGC','TEMP_AIR_PORT_DEGC']].mean(axis=1) # Average the temperature for port and starboard
Temp_V2_18           = np.array(D4_V2_18['Temp_Avg'])

Temp_s_V3_18         = np.array(D4_V3_18['TEMP_AIR_STRBRD_DEGC'])                           # starboard side temperature
Temp_p_V3_18         = np.array(D4_V3_18['TEMP_AIR_PORT_DEGC'])                             # port side temperature
D4_V3_18['Temp_Avg'] = D4_V3_18[['TEMP_AIR_STRBRD_DEGC','TEMP_AIR_PORT_DEGC']].mean(axis=1) # Average the temperature for port and starboard
Temp_V3_18           = np.array(D4_V3_18['Temp_Avg'])
...
#------------------------------------------------------------------------------
# Filter dataframe for when temperature is < 0 degrees

#-----------------------------
# Low Wind Speed (<7 m/s)
#-----------------------------
V1_17F1L   = (D4_V1_17L['Temp_Avg'] < -5)
D4_V1_17L  = D4_V1_17L[V1_17F1L]

V2_17F1L   = (D4_V2_17L['Temp_Avg'] < -5)
D4_V2_17L  = D4_V2_17L[V2_17F1L]

V3_17F1L   = (D4_V3_17L['Temp_Avg'] < -5)
D4_V3_17L  = D4_V3_17L[V3_17F1L]

V1_18F1L   = (D4_V1_18L['Temp_Avg'] < -5)
D4_V1_18L  = D4_V1_18L[V1_18F1L]

V2_18F1L   = (D4_V2_18L['Temp_Avg'] < -5)
D4_V2_18L  = D4_V2_18L[V2_18F1L]

V3_18F1L   = (D4_V3_18L['Temp_Avg'] < -5)
D4_V3_18L  = D4_V3_18L[V3_18F1L]

#-----------------------------
# High Wind Speed (>=7 m/s)
#-----------------------------
V1_17F1H   = (D4_V1_17H['Temp_Avg'] < -5)
D4_V1_17H  = D4_V1_17H[V1_17F1H]

V2_17F1H   = (D4_V2_17H['Temp_Avg'] < -5)
D4_V2_17H  = D4_V2_17H[V2_17F1H]

V3_17F1H   = (D4_V3_17H['Temp_Avg'] < -5)
D4_V3_17H  = D4_V3_17H[V3_17F1H]

V1_18F1H   = (D4_V1_18H['Temp_Avg'] < -5)
D4_V1_18H  = D4_V1_18H[V1_18F1H]

V2_18F1H   = (D4_V2_18H['Temp_Avg'] < -5)
D4_V2_18H  = D4_V2_18H[V2_18F1H]

V3_18F1H   = (D4_V3_18H['Temp_Avg'] < -5)
D4_V3_18H  = D4_V3_18H[V3_18F1H]
...
# Surface Layer
BrO_V1_17LS   = np.array(D4_V1_17L[0.1])   * 1e6 # convert from ppmv to pptv
BrO_V2_17LS   = np.array(D4_V2_17L[0.1])   * 1e6 # convert from ppmv to pptv
BrO_V3_17LS   = np.array(D4_V3_17L[0.1])   * 1e6 # convert from ppmv to pptv
BrO_V1_18LS   = np.array(D4_V1_18L[0.1])   * 1e6 # convert from ppmv to pptv
BrO_V2_18LS   = np.array(D4_V2_18L[0.1])   * 1e6 # convert from ppmv to pptv
BrO_V3_18LS   = np.array(D4_V3_18L[0.1])   * 1e6 # convert from ppmv to pptv

# Boundary Layer
BrO_V1_17LB   = np.array(D4_V1_17L[0.3])   * 1e6 # convert from ppmv to pptv
BrO_V2_17LB   = np.array(D4_V2_17L[0.3])   * 1e6 # convert from ppmv to pptv
BrO_V3_17LB   = np.array(D4_V3_17L[0.3])   * 1e6 # convert from ppmv to pptv
BrO_V1_18LB   = np.array(D4_V1_18L[0.3])   * 1e6 # convert from ppmv to pptv
BrO_V2_18LB   = np.array(D4_V2_18L[0.3])   * 1e6 # convert from ppmv to pptv
BrO_V3_18LB   = np.array(D4_V3_18L[0.3])   * 1e6 # convert from ppmv to pptv
...
# Surface Layer 
BrO_V1_17HS   = np.array(D4_V1_17H[0.1])   * 1e6 # convert from ppmv to pptv
BrO_V2_17HS   = np.array(D4_V2_17H[0.1])   * 1e6 # convert from ppmv to pptv
BrO_V3_17HS   = np.array(D4_V3_17H[0.1])   * 1e6 # convert from ppmv to pptv
BrO_V1_18HS   = np.array(D4_V1_18H[0.1])   * 1e6 # convert from ppmv to pptv
BrO_V2_18HS   = np.array(D4_V2_18H[0.1])   * 1e6 # convert from ppmv to pptv
BrO_V3_18HS   = np.array(D4_V3_18H[0.1])   * 1e6 # convert from ppmv to pptv

# Boundary Layer 
BrO_V1_17HB   = np.array(D4_V1_17H[0.3])   * 1e6 # convert from ppmv to pptv
BrO_V2_17HB   = np.array(D4_V2_17H[0.3])   * 1e6 # convert from ppmv to pptv
BrO_V3_17HB   = np.array(D4_V3_17H[0.3])   * 1e6 # convert from ppmv to pptv
BrO_V1_18HB   = np.array(D4_V1_18H[0.3])   * 1e6 # convert from ppmv to pptv
BrO_V2_18HB   = np.array(D4_V2_18H[0.3])   * 1e6 # convert from ppmv to pptv
BrO_V3_18HB   = np.array(D4_V3_18H[0.3])   * 1e6 # convert from ppmv to pptv
