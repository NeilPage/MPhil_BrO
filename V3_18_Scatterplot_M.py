...
plt.annotate("O$_3$ and BrO:\n (slope: "+str("%7.4f"%(slopeD1))+" $\pm$"+str("%7.4f"%(std_errD1))+" pptv, r: "+str("%7.4f"%(rD1))+")", xy=(6.0,11.0), color='black', fontweight='bold')
...
plt.annotate("Temperature and BrO:\n (slope: "+str("%7.4f"%(slopeD2))+" $\pm$"+str("%7.4f"%(std_errD2))+" $^\circ$C, r: "+str("%7.4f"%(rD2))+")", xy=(-7.0,11.0), color='black', fontweight='bold')
...
plt.annotate("Wind vector direction and BrO:\n (slope: "+str("%7.4f"%(slopeD3))+" $\pm$"+str("%7.4f"%(std_errD3))+" $^\circ$, r: "+str("%7.4f"%(rD3))+")", xy=(10.0,10.0), color='black', fontweight='bold')
...
plt.annotate("Wind speed and BrO:\n (slope: "+str("%7.4f"%(slopeD4))+" $\pm$"+str("%7.4f"%(std_errD4))+" m/s, r: "+str("%7.4f"%(rD4))+")", xy=(0.0,11.0), color='black', fontweight='bold')
...
plt.annotate("Sea Ice Concentration and BrO:\n (slope: "+str("%7.4f"%(slopeD7))+" $\pm$"+str("%7.4f"%(std_errD7))+" %, r: "+str("%7.4f"%(rD7))+")", xy=(2.0,11.0), color='black', fontweight='bold')
