...
BrOLS = np.concatenate((BrO_V1_17LS, BrO_V2_17LS, BrO_V3_17LS, BrO_V1_18LS, BrO_V2_18LS, BrO_V3_18LS, BrO_SIPEXIILS), axis=0)

# BrO boundary volume mixing ratio (VMR)
BrOLB = np.concatenate((BrO_V1_17LB, BrO_V2_17LB, BrO_V3_17LB, BrO_V1_18LB, BrO_V2_18LB, BrO_V3_18LB, BrO_SIPEXIILB), axis=0)
...
# BrO surface volume mixing ratio (VMR)
BrOHS = np.concatenate((BrO_V1_17HS, BrO_V2_17HS, BrO_V3_17HS, BrO_V1_18HS, BrO_V2_18HS, BrO_V3_18HS, BrO_SIPEXIIHS), axis=0)

# BrO boundary volume mixing ratio (VMR)
BrOHB = np.concatenate((BrO_V1_17HB, BrO_V2_17HB, BrO_V3_17HB, BrO_V1_18HB, BrO_V2_18HB, BrO_V3_18HB, BrO_SIPEXIIHB), axis=0)
...
# Plot the label for the regression line
plt.annotate("Wind vector direction and BrO:\n (slope: "+str("%7.4f"%(slopeD3LS))+" $\pm$"+str("%7.4f"%(std_errD3LS))+" $^\circ$, r: "+str("%7.4f"%(rD3_V1_17LS))+")", xy=(10.0,18.0), color='black', fontweight='bold', fontsize=15)
