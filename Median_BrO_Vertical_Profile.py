...
# Plot Title
plt.title('Median BrO Vertical Profile', fontsize=25, pad=20)
...
# Mean
ax.errorbar(Median_V2_18S,   Mean_V2_18S.index,   marker='o', c='orange', markersize = 3.0, ls='-', label ='V2 (2018/19)',   xerr=MAD_V2_18S,   capsize=2)
