...
# Hg0
#---------
Hg0_V1_17 = pd.read_csv('/Users/ncp532/Documents/Data/SIPEXII_2012/SIPEXII_Hg_Air/SIPEXII_Hg0_QAQC_2012.csv', index_col=0)
...
# XARRAY
#cubes_E24a = xr.open_dataset('/Users/ncp532/Documents/Data/Sea_Ice_Cover/Hamburg_ICDC/20120926_median5day.nc', decode_cf=False, engine='netcdf4')
#cubes_E25a = xr.open_dataset('/Users/ncp532/Documents/Data/Sea_Ice_Cover/Hamburg_ICDC/20120928_median5day.nc', decode_cf=False, engine='netcdf4')
#cubes_E26a = xr.open_dataset('/Users/ncp532/Documents/Data/Sea_Ice_Cover/Hamburg_ICDC/20121015_median5day.nc', decode_cf=False, engine='netcdf4')

cubes_E24b = xr.open_dataset('/Users/ncp532/Documents/Data/Sea_Ice_Cover/NSIDC/2012/seaice_conc_daily_sh_f17_20120926_v03r01.nc', decode_cf=False, engine='netcdf4')
cubes_E25b = xr.open_dataset('/Users/ncp532/Documents/Data/Sea_Ice_Cover/NSIDC/2012/seaice_conc_daily_sh_f17_20120928_v03r01.nc', decode_cf=False, engine='netcdf4')
cubes_E26b = xr.open_dataset('/Users/ncp532/Documents/Data/Sea_Ice_Cover/NSIDC/2012/seaice_conc_daily_sh_f17_20121015_v03r01.nc', decode_cf=False, engine='netcdf4')

#-------------
# Back Trajectories (EVENT 24)
#-------------
...
Traj_E24 = pd.concat(Traj)

#-------------
# Back Trajectories (EVENT 25)
#-------------
# Set the location for the working directory
os.chdir("/Users/ncp532/Documents/Data/SeaIce_Trajectories/100m/")
...
# Combine all the files
Traj_E25 = pd.concat(Traj)

#-------------
# Back Trajectories (EVENT 26)
#-------------
# Set the location for the working directory
os.chdir("/Users/ncp532/Documents/Data/SeaIce_Trajectories/100m/")
...
# Back Trajectories ( EVENT 24)
#-------------
Traj_E24['year']     = Traj_E24['Traj Year']
Traj_E24['month']    = Traj_E24['Traj Mon']
Traj_E24['day']      = Traj_E24['Traj Day']
Traj_E24['hour']     = Traj_E24['Traj Hour']
Traj_E24['minute']   = Traj_E24['Traj Min']
Traj_E24['DateTime'] = pd.to_datetime(Traj_E24[['year', 'month', 'day', 'hour', 'minute']])
Traj_E24.index       = (pd.to_datetime(Traj_E24['DateTime']) + timedelta(hours=8)) # Davis timezone is UT+7

#-------------
# Back Trajectories ( EVENT 25)
#-------------
Traj_E25['year']     = Traj_E25['Traj Year']
Traj_E25['month']    = Traj_E25['Traj Mon']
Traj_E25['day']      = Traj_E25['Traj Day']
Traj_E25['hour']     = Traj_E25['Traj Hour']
Traj_E25['minute']   = Traj_E25['Traj Min']
Traj_E25['DateTime'] = pd.to_datetime(Traj_E25[['year', 'month', 'day', 'hour', 'minute']])
Traj_E25.index       = (pd.to_datetime(Traj_E25['DateTime']) + timedelta(hours=8)) # Davis timezone is UT+7

#-------------
# Back Trajectories ( EVENT 26)
#-------------
Traj_E26['year']     = Traj_E26['Traj Year']
Traj_E26['month']    = Traj_E26['Traj Mon']
Traj_E26['day']      = Traj_E26['Traj Day']
Traj_E26['hour']     = Traj_E26['Traj Hour']
Traj_E26['minute']   = Traj_E26['Traj Min']
Traj_E26['DateTime'] = pd.to_datetime(Traj_E26[['year', 'month', 'day', 'hour', 'minute']])
Traj_E26.index       = (pd.to_datetime(Traj_E26['DateTime']) + timedelta(hours=8)) # Davis timezone is UT+7
...
# #HAMBURG
# seaice_data_E24a = cubes_E24a.variables['sea_ice_area_fraction'][0,:,:] # Sea Ice concentration (time,y,x)(1,664,632)
# lats_E24a        = cubes_E24a.latitude
# lons_E24a        = cubes_E24a.longitude

# seaice_data_E25a = cubes_E25a.variables['sea_ice_area_fraction'][0,:,:] # Sea Ice concentration (time,y,x)(1,664,632)
# lats_E25a        = cubes_E25a.latitude
# lons_E25a        = cubes_E25a.longitude

# seaice_data_E26a = cubes_E26a.variables['sea_ice_area_fraction'][0,:,:] # Sea Ice concentration (time,y,x)(1,664,632)
# lats_E26a        = cubes_E26a.latitude
# lons_E26a        = cubes_E26a.longitude

# NSIDC
seaice_data_E24a = cubes_E24b.variables['seaice_conc_cdr'][0,:,:] # Sea Ice concentration (time,y,x)(1,664,632)
lats_E24a        = cubes_E24b.latitude
lons_E24a        = cubes_E24b.longitude

seaice_data_E25a = cubes_E25b.variables['seaice_conc_cdr'][0,:,:] # Sea Ice concentration (time,y,x)(1,664,632)
lats_E25a        = cubes_E25b.latitude
lons_E25a        = cubes_E25b.longitude

seaice_data_E26a = cubes_E26b.variables['seaice_conc_cdr'][0,:,:] # Sea Ice concentration (time,y,x)(1,664,632)
lats_E26a        = cubes_E26b.latitude
lons_E26a        = cubes_E26b.longitude
...
start  = ax.axvline(datetime(2012,9,26,8,10,0),  linewidth=1.0, color='r')
finish = ax.axvline(datetime(2012,9,26,11,50,0),  linewidth=1.0, color='r')

# Text box for Start/Finish
props = dict(boxstyle='round', facecolor='white', alpha=1.0)
ax3.text(datetime(2012,9,26,8,10,0), 113,  "Start",  color='r', fontsize=10, verticalalignment='top', horizontalalignment='center', bbox=props)
ax3.text(datetime(2012,9,26,11,50,0), 113,  "Finish", color='r', fontsize=10, verticalalignment='top', horizontalalignment='center', bbox=props)
...
ax4.set_ylim(60,100) # On Station
...
seaice_data_E24a = np.ma.masked_where(seaice_data_E24a==0,seaice_data_E24a)
#cmap=cm.get_cmap('viridis')
cmap=cmocean.cm.ice
cmap.set_bad(color='lightgrey')
cs = ax.pcolormesh(lons_E24a, lats_E24a, seaice_data_E24a, transform=data_crs, cmap=cmap) #, bins=np.arange(0,100, 10))
...
ax.scatter(Traj_E24['Traj Lon'], Traj_E24['Traj Lat'], zorder=2, cmap=cmap, transform=data_crs, marker='o', s=1, norm=norm, c=Traj_E24['IceContact_100m'], label='Traj Height (m)')
...
cs1 = ax.scatter(Traj_E24['Traj Age'], Traj_E24['Traj Height (m)'], marker='o', s=1, cmap=cmap, norm=norm, c=Traj_E24['IceContact_100m'], label='Traj Height (m)')
ax.plot(Traj_E24['Traj Age'][0], Traj_E24['Traj Height (m)'][0], color='k', marker='*')
...
# Plot Start/Finish time for high BrO event
start  = ax.axvline(datetime(2012,9,28,10,30,0), linewidth=1.0, color='r')
finish = ax.axvline(datetime(2012,9,28,17,30,0), linewidth=1.0, color='r')

# Text box for Start/Finish
props = dict(boxstyle='round', facecolor='white', alpha=1.0)
ax3.text(datetime(2012,9,28,10,30,0),  113, "Start",  color='r', fontsize=10, verticalalignment='top', horizontalalignment='center', bbox=props)
ax3.text(datetime(2012,9,28,17,30,0), 113,  "Finish", color='r', fontsize=10, verticalalignment='top', horizontalalignment='center', bbox=props)
...
ax4.yaxis.set_major_locator(ticker.MultipleLocator(10))
ax4.yaxis.set_minor_locator(ticker.MultipleLocator(5))
ax4.set_ylim(80,100) # On Station
ax4.yaxis.label.set_color('magenta')
ax4.tick_params(axis='y', which='both', colors='magenta', labelsize=10)
ax4.spines["right"].set_position(("axes", 1.22))
ax4.spines["right"].set_color('magenta')
...
# PLOT THE DATA (SEA ICE CONCENTRATION) 
seaice_data_E25a = np.ma.masked_where(seaice_data_E25a==0,seaice_data_E25a)
#cmap=cm.get_cmap('viridis')
cmap=cmocean.cm.ice
cmap.set_bad(color='lightgrey')
cs = ax.pcolormesh(lons_E25a, lats_E25a, seaice_data_E25a, transform=data_crs, cmap=cmap) #, bins=np.arange(0,100, 10))
#cs = ax.pcolormesh(lons, lats, seaice_data, transform=data_crs, cmap=cmocean.cm.ice) #, bins=np.arange(0,100, 10))
...
#ax.scatter(Traj['Traj Lon'], Traj['Traj Lat'], zorder=2, cmap=cmap, transform=data_crs, marker='o', s=1, norm=norm, c=Traj['Traj Age'], label='Traj Height (m)')
ax.scatter(Traj_E25['Traj Lon'], Traj_E25['Traj Lat'], zorder=2, cmap=cmap, transform=data_crs, marker='o', s=1, norm=norm, c=Traj_E25['IceContact_100m'], label='Traj Height (m)')
...
#cs1 = ax.scatter(Traj['Traj Age'], Traj['Traj Height (m)'], marker='o', s=1, cmap=cmap, norm=norm, c=Traj['Traj Age'], label='Traj Height (m)')
cs1 = ax.scatter(Traj_E25['Traj Age'], Traj_E25['Traj Height (m)'], marker='o', s=1, cmap=cmap, norm=norm, c=Traj_E25['IceContact_100m'], label='Traj Height (m)')
ax.plot(Traj_E25['Traj Age'][0], Traj_E25['Traj Height (m)'][0], color='k', marker='*')
...
# Plot Start/Finish time for high BrO event
start  = ax.axvline(datetime(2012,10,15,15,50,0), linewidth=1.0, color='r')
finish = ax.axvline(datetime(2012,10,15,17,30,0), linewidth=1.0, color='r')

# Text box for Start/Finish
props = dict(boxstyle='round', facecolor='white', alpha=1.0)
ax3.text(datetime(2012,10,15,15,50,0),  113, "Start",  color='r', fontsize=10, verticalalignment='top', horizontalalignment='center', bbox=props)
ax3.text(datetime(2012,10,15,17,30,0), 113, "Finish", color='r', fontsize=10, verticalalignment='top', horizontalalignment='center', bbox=props)
...
ax4.yaxis.set_major_locator(ticker.MultipleLocator(10))
ax4.yaxis.set_minor_locator(ticker.MultipleLocator(5))
ax4.set_ylim(80,105) # On Station
ax4.yaxis.label.set_color('magenta')
ax4.tick_params(axis='y', which='both', colors='magenta', labelsize=10)
ax4.spines["right"].set_position(("axes", 1.22))
ax4.spines["right"].set_color('magenta')
...
# PLOT THE DATA (SEA ICE CONCENTRATION) 
seaice_data_E26a = np.ma.masked_where(seaice_data_E26a==0,seaice_data_E26a)
#cmap=cm.get_cmap('viridis')
cmap=cmocean.cm.ice
cmap.set_bad(color='lightgrey')
cs = ax.pcolormesh(lons_E26a, lats_E26a, seaice_data_E26a, transform=data_crs, cmap=cmap) #, bins=np.arange(0,100, 10))
#cs = ax.pcolormesh(lons, lats, seaice_data, transform=data_crs, cmap=cmocean.cm.ice) #, bins=np.arange(0,100, 10))
...
#ax.scatter(Traj['Traj Lon'], Traj['Traj Lat'], zorder=2, cmap=cmap, transform=data_crs, marker='o', s=1, norm=norm, c=Traj['Traj Age'], label='Traj Height (m)')
ax.scatter(Traj_E26['Traj Lon'], Traj_E26['Traj Lat'], zorder=2, cmap=cmap, transform=data_crs, marker='o', s=1, norm=norm, c=Traj_E26['IceContact_100m'], label='Traj Height (m)')
...
#cs1 = ax.scatter(Traj['Traj Age'], Traj['Traj Height (m)'], marker='o', s=1, cmap=cmap, norm=norm, c=Traj['Traj Age'], label='Traj Height (m)')
cs1 = ax.scatter(Traj_E26['Traj Age'], Traj_E26['Traj Height (m)'], marker='o', s=1, cmap=cmap, norm=norm, c=Traj_E26['IceContact_100m'], label='Traj Height (m)')
ax.plot(Traj_E26['Traj Age'][0], Traj_E26['Traj Height (m)'][0], color='k', marker='*')
