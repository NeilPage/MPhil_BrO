...
# NO2 VMR
NO2 = pd.read_csv('/Users/ncp532/Documents/data/V1_17_APriori/V3_18/all_NO2/V3_18_NO2_VMR.csv',index_col=0) # NO2 data for CAMPCANN V3 (2018/19)

# NO2 Error
NO2_Error = pd.read_csv('/Users/ncp532/Documents/data/V1_17_APriori/V3_18/NO2_error/V3_18_NO2_error.csv', index_col=0) # NO2 error data for CAMPCANN V3 (2018/19)
...
# BrO AOD
BrO_AOD = pd.read_csv('/Users/ncp532/Documents/data/V1_17_APriori/V3_18/all_AOD/V3_18_AOD_338.csv',index_col=0) # AOD data for CAMPCANN V3 (2018/19)

# NO2_AOD
NO2_AOD = pd.read_csv('/Users/ncp532/Documents/data/V1_17_APriori/V3_18/all_AOD/V3_18_AOD_375.csv',index_col=0) # AOD data for CAMPCANN V3 (2018/19)

#---------
# SZA
#---------

DF4_SZA = pd.read_csv('/Users/ncp532/Documents/data/V1_17_APriori/V3_18/all_SZA/V3_18_SZA.csv',index_col=0) # SZA data for CAMPCANN V3 (2018/19)
...
# Filtered
y = V3_18T.index # set the values for the y-axis
x = np.array(V3_18T.dtypes.index) # set the values for the x-axis
z = V3_18T.copy() # identify the matrix containing the z-values (BrO in ppMv)
...
plt.xlim(datetime(2019,1,30,0,0,0),datetime(2019,2,10,0,0,5))
...
# #plt.title('CAMMPCAN V3 2018-19 NO$_2$ VMR', fontsize=25)
# plt.xlim(datetime(2019,1,30,0,0,0),datetime(2019,2,10,0,0,5))
