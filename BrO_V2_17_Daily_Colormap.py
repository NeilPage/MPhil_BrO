...
# BrO VMR
V1_2017 = pd.read_csv('/Users/ncp532/Documents/data/V1_17_APriori/V2_17/all_BrO/V2_17_BrO_VMR.csv', index_col=0) # BrO data for CAMPCANN V1 (2018/19)

# BrO Error
V1_Error = pd.read_csv('/Users/ncp532/Documents/data/V1_17_APriori/V2_17/BrO_error/V2_17_BrO_error.csv', index_col=0) # BrO error data for CAMPCANN V1 (2018/19)
...
# NO2 VMR
NO2 = pd.read_csv('/Users/ncp532/Documents/data/V1_17_APriori/V2_17/all_NO2/V2_17_NO2_VMR.csv',index_col=0) # NO2 data for CAMPCANN V1 (2018/19)

# NO2 Error
NO2_Error = pd.read_csv('/Users/ncp532/Documents/data/V1_17_APriori/V2_17/NO2_error/V2_17_NO2_error.csv', index_col=0) # NO2 error data for CAMPCANN V1 (2018/19)
...
# BrO AOD
BrO_AOD = pd.read_csv('/Users/ncp532/Documents/data/V1_17_APriori/V2_17/all_AOD/V2_17_AOD_338.csv',index_col=0) # AOD data for CAMMPCAN V1 (2018/19)

# NO2_AOD
NO2_AOD = pd.read_csv('/Users/ncp532/Documents/data/V1_17_APriori/V2_17/all_AOD/V2_17_AOD_375.csv',index_col=0) # AOD data for CAMMPCAN V1 (2018/19)

#---------
# SZA
#---------

DF4_SZA = pd.read_csv('/Users/ncp532/Documents/data/V1_17_APriori/V2_17/all_SZA/V2_17_SZA.csv',index_col=0) # SZA data for CAMPCANN V1 (2018/19)
...
plt.xlim(datetime(2017,12,21,0,0,0),datetime(2017,12,21,23,59,59))
...
# Plot the title
plt.title('21 December 2017', fontsize=25, pad=10)
plt.show()
