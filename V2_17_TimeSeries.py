...
# BrO Data
V2_BrO = pd.read_csv('/Users/ncp532/Documents/Data/V1_17_APriori/V2_17_Data.csv')

## NO2 Data
#V2_NO2 = pd.read_csv('/Users/ncp532/Documents/Data/CAMMPCAN_2017_18/TG_Retrieval_V2/V2_NO2_QAQC.csv')

# O3 Data
V2_O3 = pd.read_csv('/Users/ncp532/Documents/Data/CAMMPCAN_2017_18/ARM/V2_O3_1min.csv')

# Met data
V2_Met = pd.read_csv('/Users/ncp532/Documents/Data/CAMMPCAN_2017_18/V02/CAMMPCAN_V2_underway_60.csv') 

# Hg Data
V2_Hg = pd.read_csv('/Users/ncp532/Documents/Data/CAMMPCAN_2017_18/CAMMPCAN_V2_Hg0_Lat_Long_17-18.csv')

#------------------------------------------------------------------------------
# FIX UP THE BrO DATASET

# Set the date
V2_BrO['DateTime'] = pd.to_datetime(V2_BrO['DateTime'])

# V2_17 Casey (08:00 to 16:00)
start_time = '08:00:00'
end_time = '16:00:00'
Midday = (V2_BrO['Time'] >= start_time) & (V2_BrO['Time'] < end_time)
V2_BrO_MM = V2_BrO[Midday]

# Filter dataframe for when filter is less than 60%
V2_BrOF = (V2_BrO_MM['Filter'] < 0.6)
V2_BrOT = V2_BrO_MM[V2_BrOF]
...
BrO_vmr_V1_18 = np.array(V2_BrOT['surf_vmr(ppmv)']) * 1e6 # convert from ppmv to pptv
...
# O3 (ppb)
O3_V1_18 = np.array(V2_O3['O3_(ppb)']) # all O3 data
...
# V1_BrO
dat = np.array(V2_BrOT['Date'])
tim = np.array(V2_BrOT['Time'])
dattim = dat+' '+tim
...
# V1_O3
dat2 = np.array(V2_O3['Date'])
tim2 = np.array(V2_O3['Time'])
dattim2 = dat2+' '+tim2
...
plt.xlim(datetime(2017,12,13),datetime(2018,1,11)) # all dates
...
plt.title('Time series for V2 (CAMMPCAN 2017-18)', fontsize=25, y=1.2)
