...
V3_2017_18 = pd.read_csv('/Users/ncp532/Documents/Data/V1_17_APriori/V3_17/all_BrO/all_BrO_vmr_prof_20180127.dat', sep='\s+', index_col=0) # BrO data for CAMPCANN V3 (2017/18)

# CAMMPCAN 2018-19
#V1_2018_19 = pd.read_csv('/Users/ncp532/Documents/Data/V1_17_APriori/V3_17/all_BrO/all_BrO_vmr_prof_20181107.dat', sep='\s+', index_col=0) # BrO data for CAMPCANN V1 (2018/19)
...
d0 = datetime(2018,1,27,0,10,0)
end = datetime(2018,1,27,23,59,59)
...
# CAMMPCAN
y = V3_2017_18.index # set the values for the y-axis
x = np.array(V3_2017_18.dtypes.index) # set the values for the x-axis

z = V3_2017_18.copy() # identify the matrix containing the z-values (BrO in ppMv)
z[z==-9999]=np.nan # set the erroneous values as NaN 
z = z.loc[:]*1e6 # change from ppMv to pptv
...
plt.title('BrO VCD (27 Jan 2018)', fontsize=25)
