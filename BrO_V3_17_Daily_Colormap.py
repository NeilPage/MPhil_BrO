...
# BrO VMR
V1_2017 = pd.read_csv('/Users/ncp532/Documents/data/V1_17_APriori/V3_17/all_BrO/V3_17_BrO_VMR.csv', index_col=0) # BrO data for CAMPCANN V1 (2018/19)
...
plt.xlim(datetime(2018,1,30,0,0,0),datetime(2018,1,30,23,59,59))
...
# Plot the title
plt.title('30 January 2018', fontsize=25, pad=10)
plt.show()
