...
# Plot the variables
ax.plot(time1_HM, BrO_V1_17_HM, marker='o', c='blue', markersize = 3.0, ls='-', label ='Davis (V1)')
ax2.scatter(time1_SZA_HMed, SZA_V1_17_HMed, marker='x', color='Orange')

UL1 = BrO_V1_17_HM + BrO_V1_17_STD # find the upper limit
LL1 = BrO_V1_17_HM - BrO_V1_17_STD # find the lower limit
ax.plot(time1_HM, UL1, 'b-', linewidth=2, alpha=0.3, label='_nolegend_')   # plot the upper limit
ax.plot(time1_HM, LL1, 'b-', linewidth=2, alpha=0.3, label='_nolegend_')   # plot the lower limit
ax.fill_between(time1_HM, UL1, LL1, facecolor='blue', alpha=0.3) # fill the distribution
...
# Plot the variables
ax.plot(time2_HM, BrO_V2_17_HM, marker='o', c='blue', markersize = 3.0, ls='-', label ='Casey (V2)')
ax2.scatter(time2_SZA_HMed, SZA_V2_17_HMed, marker='x', color='Orange')

UL2 = BrO_V2_17_HM + BrO_V2_17_STD # find the upper limit
LL2 = BrO_V2_17_HM - BrO_V2_17_STD # find the lower limit
ax.plot(time2_HM, UL2, 'b-', linewidth=2, alpha=0.3, label='_nolegend_')   # plot the upper limit
ax.plot(time2_HM, LL2, 'b-', linewidth=2, alpha=0.3, label='_nolegend_')   # plot the lower limit
ax.fill_between(time2_HM, UL2, LL2, facecolor='blue', alpha=0.3) # fill the distribution
...
# Plot the variables
ax.plot(time3_HM, BrO_V3_17_HM, marker='o', c='blue', markersize = 3.0, ls='-', label ='Mawson (V3)')
ax2.scatter(time3_SZA_HMed, SZA_V3_17_HMed, marker='x', color='Orange')

UL3 = BrO_V3_17_HM + BrO_V3_17_STD # find the upper limit
LL3 = BrO_V3_17_HM - BrO_V3_17_STD # find the lower limit
ax.plot(time3_HM, UL3, 'b-', linewidth=2, alpha=0.3, label='_nolegend_')   # plot the upper limit
ax.plot(time3_HM, LL3, 'b-', linewidth=2, alpha=0.3, label='_nolegend_')   # plot the lower limit
ax.fill_between(time3_HM, UL3, LL3, facecolor='blue', alpha=0.3) # fill the distribution
...
# Plot the variables
ax.plot(time4_HM, BrO_V1_18_HM, marker='o', c='red', markersize = 3.0, ls='-', label ='Davis (V1)')
ax2.scatter(time4_SZA_HMed, SZA_V1_18_HMed, marker='x', color='Orange')

UL4 = BrO_V1_18_HM + BrO_V1_18_STD # find the upper limit
LL4 = BrO_V1_18_HM - BrO_V1_18_STD # find the lower limit
ax.plot(time4_HM, UL4, 'r-', linewidth=2, alpha=0.3, label='_nolegend_')   # plot the upper limit
ax.plot(time4_HM, LL4, 'r-', linewidth=2, alpha=0.3, label='_nolegend_')   # plot the lower limit
ax.fill_between(time4_HM, UL4, LL4, facecolor='red', alpha=0.3) # fill the distribution
...
# Plot the variables
ax.plot(time5_HM, BrO_V2_18_HM, marker='o', c='red', markersize = 3.0, ls='-', label ='Casey (V2)')
ax2.scatter(time5_SZA_HMed, SZA_V2_18_HMed, marker='x', color='Orange')

UL5 = BrO_V2_18_HM + BrO_V2_18_STD # find the upper limit
LL5 = BrO_V2_18_HM - BrO_V2_18_STD # find the lower limit
ax.plot(time5_HM, UL5, 'r-', linewidth=2, alpha=0.3, label='_nolegend_')   # plot the upper limit
ax.plot(time5_HM, LL5, 'r-', linewidth=2, alpha=0.3, label='_nolegend_')   # plot the lower limit
ax.fill_between(time5_HM, UL5, LL5, facecolor='red', alpha=0.3) # fill the distribution
...
# Plot the variables
ax.plot(time6_HM, BrO_V3_18_HM, marker='o', c='red', markersize = 3.0, ls='-', label ='Mawson (V3)')
ax2.scatter(time6_SZA_HMed, SZA_V3_18_HMed, marker='x', color='Orange')

UL6 = BrO_V3_18_HM + BrO_V3_18_STD # find the upper limit
LL6 = BrO_V3_18_HM - BrO_V3_18_STD # find the lower limit
ax.plot(time6_HM, UL6, 'r-', linewidth=2, alpha=0.3, label='_nolegend_')   # plot the upper limit
ax.plot(time6_HM, LL6, 'r-', linewidth=2, alpha=0.3, label='_nolegend_')   # plot the lower limit
ax.fill_between(time6_HM, UL6, LL6, facecolor='red', alpha=0.3) # fill the distribution
...
# Plot the variables
ax.plot(time7_HM, BrO_SIPEXII_HM, marker='o', c='green', markersize = 3.0, ls='-', label ='SIPEXII')
ax2.scatter(time7_SZA_HMed, SZA_SIPEXII_HMed, marker='x', color='Orange')

UL7 = BrO_SIPEXII_HM + BrO_SIPEXII_STD # find the upper limit
LL7 = BrO_SIPEXII_HM - BrO_SIPEXII_STD # find the lower limit
ax.plot(time7_HM, UL7, 'g-', linewidth=2, alpha=0.3, label='_nolegend_')   # plot the upper limit
ax.plot(time7_HM, LL7, 'g-', linewidth=2, alpha=0.3, label='_nolegend_')   # plot the lower limit
ax.fill_between(time7_HM, UL7, LL7, facecolor='green', alpha=0.3) # fill the distribution
