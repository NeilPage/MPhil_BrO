...
DF3_AOD = pd.read_csv('/Users/ncp532/Documents/data/V1_17_APriori/V1_17/all_AOD/V1_17_AOD.csv',index_col=0) # AOD data for CAMPCANN V1 (2017/18)
...
plt.xlim(datetime(2017,11,18,0,0,0),datetime(2017,11,18,23,59,59))
