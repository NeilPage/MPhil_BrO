...
# Mean
plt.pcolormesh(Mean_allS.columns, Mean_allS.index, Mean_allS, vmin=0, vmax=10, norm=norm, cmap=cmap,edgecolors='k', linewidths=2)
ax.pcolormesh(Mean_allS.columns, Mean_allS.index, Mean_allS, vmin=0, vmax=10, norm=norm, cmap=cmap,edgecolors='k', linewidths=2)

# Median
#plt.pcolormesh(Median_allS.columns, Median_allS.index, Median_allS, vmin=0, vmax=10, norm=norm, cmap=cmap,edgecolors='k', linewidths=2)
#ax.pcolormesh(Median_allS.columns, Median_allS.index, Median_allS, vmin=0, vmax=10, norm=norm, cmap=cmap,edgecolors='k', linewidths=2)
...
#tick_locator = ticker.MinNLocator(nbins=11)
clb.locator = tick_locator
clb.update_ticks()

# Plot Title
plt.title('Mean BrO VCD', fontsize=25, pad=20)
...
## Format x-axis
ax.set_xticks(np.arange(len(Mean_all.columns))+0.5)
ax.set_xticklabels(Mean_all.columns)
ax.set_xlim(0,7.0) # On Station
