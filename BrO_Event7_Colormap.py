...
DF3_AOD = pd.read_csv('/Users/ncp532/Documents/data/V1_17_APriori/SIPEXII/all_AOD/SIPEXII_AOD.csv',index_col=0) # AOD data for SIPEXII (2012)
...
cmap = plt.cm.jet
norm = BoundaryNorm(np.arange(0,18,1), cmap.N)

plt.pcolormesh(date, y, mz, vmin=0, vmax=18.5, norm=norm, cmap=cmap)
ax.pcolormesh(date, y, mz, vmin=0, vmax=18.5, norm=norm, cmap=cmap)
...
tick_locator = ticker.MaxNLocator(nbins=18)
...
#ax3.scatter(date4, SZA, marker='x', color='Brown', label ='SZA')
#
##plt.title('SIPEXII NO$_2$ VMR', fontsize=25)
#plt.xlim(datetime(2012,9,23,0,1,0),datetime(2012,11,12,0,0,5))
#
#ax.set_ylabel('Altitude (km)', fontsize=20)
#ax2.set_ylabel('AOD', fontsize=20)
#ax3.set_ylabel('SZA ($^\circ$)', fontsize=20)
