...
# BrO Data
V1_BrO = pd.read_csv('/Users/ncp532/Documents/Data/CAMMPCAN_2018_19/TG_Retrieval_V1/V1_BrO_QAQC.csv')

# NO2 Data
V1_NO2 = pd.read_csv('/Users/ncp532/Documents/Data/CAMMPCAN_2018_19/TG_Retrieval_V1/V1_NO2_QAQC.csv')

# O3 Data
V1_O3 = pd.read_csv('/Users/ncp532/Documents/Data/CAMMPCAN_2018_19/O3/V1_O3_1min.csv')

# Met data
V1_Met = pd.read_csv('/Users/ncp532/Documents/Data/CAMMPCAN_2018_19/V01/CAMMPCAN_V1_underway_60.csv') 

# Hg Data
V1_Hg = pd.read_csv('/Users/ncp532/Documents/Data/CAMMPCAN_2018_19/CAMMPCAN_V1_Hg0_Lat_Long_18-19.csv')

#------------------------------------------------------------------------------
# RESAMPLE DATASETS TOO 1 MIN RESOLUTION

# BrO Data  
V1_BrO['DateTime'] = pd.to_datetime(V1_BrO['DateTime'], format='%d/%m/%Y %H:%M:%S')
V1_BrO = V1_BrO.set_index('DateTime')
V1_BrO = V1_BrO.resample('1T').bfill()

# NO2 Data  
V1_NO2['DateTime'] = pd.to_datetime(V1_NO2['DateTime'], format='%d/%m/%Y %H:%M:%S')
V1_NO2 = V1_NO2.set_index('DateTime')
V1_NO2 = V1_NO2.resample('1T').bfill()

# O3 Data  
V1_O3['DateTime'] = pd.to_datetime(V1_O3['DateTime'], format='%d/%m/%Y %H:%M:%S')
V1_O3 = V1_O3.set_index('DateTime')

# Met Data  
V1_Met['DateTime'] = pd.to_datetime(V1_Met['DateTime'], format='%d/%m/%Y %H:%M:%S')
V1_Met = V1_Met.set_index('DateTime')
...
V1_Met['WS_1_18'] = ((WS_s1_18 + WS_p1_18)/2) # Average the wind speed for port and starboard
WS_1_18 = np.array(V1_Met['WS_1_18'])

V1_Met['WD_vect'] = ((WD_s1_18 * WS_s1_18) / (WS_s1_18 + WS_p1_18)) + ((WD_p1_18 * WS_p1_18) / (WS_s1_18 + WS_p1_18))
WD_vect1_18 = np.array(V1_Met['WD_vect'])
...
D3 = pd.merge(left=V1_BrO,right=V1_Met, how='left', left_index=True, right_index=True)
D4 = pd.merge(left=V1_NO2,right=V1_Met, how='left', left_index=True, right_index=True)
D5 = pd.merge(left=V1_O3,right=V1_Met, how='left', left_index=True, right_index=True)
...
# BrO_2
dat6 = np.array(V1_BrO['Date'])
tim6 = np.array(V1_BrO['Time'])
dattim6 = dat6+' '+tim6
...
# NO2_2
dat7 = np.array(V1_NO2['Date'])
tim7 = np.array(V1_NO2['Time'])
dattim7 = dat7+' '+tim7
...
# O3_2
dat8 = np.array(V1_O3['Date'])
tim8 = np.array(V1_O3['Time'])
dattim8 = dat8+' '+tim8
...
plt.xlim(datetime(2018,10,24),datetime(2018,11,28)) # all dates
...
plt.title('Time series for V1 (CAMMPCAN 2018-19)', fontsize=25, y=1.2)
