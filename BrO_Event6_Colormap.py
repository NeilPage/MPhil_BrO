...
V3_2018_19 = pd.read_csv('/Users/ncp532/Documents/Data/V1_17_APriori/V3_18/all_BrO/all_BrO_vmr_prof_20190202.dat', sep='\s+', index_col=0) # BrO data for CAMPCANN V3 (2018/19)

#------------------------------------------------------------------------------
# SET THE DATE AND TIME

d0 = datetime(2019,2,2,0,10,0)
end = datetime(2019,2,2,23,59,59)
...
plt.title('BrO VCD (2 Feb 2019)', fontsize=25)
