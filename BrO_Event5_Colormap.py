...
# CAMMPCAN 2018-19
#V1_2018_19 = pd.read_csv('/Users/ncp532/Documents/Data/V1_17_APriori/V1_18/all_BrO/all_BrO_vmr_prof_20181107.dat', sep='\s+', index_col=0) # BrO data for CAMPCANN V1 (2018/19)
...
V3_2018_19 = pd.read_csv('/Users/ncp532/Documents/Data/V1_17_APriori/V3_18/all_BrO/all_BrO_vmr_prof_20190125.dat', sep='\s+', index_col=0) # BrO data for CAMPCANN V3 (2018/19)

#------------------------------------------------------------------------------
# SET THE DATE AND TIME

d0 = datetime(2019,1,25,0,10,0)
end = datetime(2019,1,25,23,59,59)
...
# CAMMPCAN
y = V3_2018_19.index # set the values for the y-axis
x = np.array(V3_2018_19.dtypes.index) # set the values for the x-axis

z = V3_2018_19.copy() # identify the matrix containing the z-values (BrO in ppMv)
z[z==-9999]=np.nan # set the erroneous values as NaN 
z = z.loc[:]*1e6 # change from ppMv to pptv
...
plt.title('BrO VCD (25 Jan 2019)', fontsize=25)
