...
# CAMMPCAN 2017-18
V1_17 = pd.read_csv('/Users/ncp532/Documents/Data/CAMMPCAN_2017_18/TG_Retrieval_V1/V1_BrO_QAQC_Time.csv') # all data
...
V2_17 = pd.read_csv('/Users/ncp532/Documents/Data/CAMMPCAN_2017_18/TG_Retrieval_V2/V2_BrO_QAQC_Time.csv') # all data
...
V3_17 = pd.read_csv('/Users/ncp532/Documents/Data/CAMMPCAN_2017_18/TG_Retrieval_V3/V3_BrO_QAQC_Time.csv') # all data
...
# CAMMPCAN 2018-19
V1_18 = pd.read_csv('/Users/ncp532/Documents/Data/CAMMPCAN_2018_19/TG_Retrieval_V1/V1_BrO_QAQC_Time.csv') # all data
...
V2_18 = pd.read_csv('/Users/ncp532/Documents/Data/CAMMPCAN_2018_19/TG_Retrieval_V2/V2_BrO_QAQC_Time.csv') # all data
...
V3_18 = pd.read_csv('/Users/ncp532/Documents/Data/CAMMPCAN_2018_19/TG_Retrieval_V3/V3_BrO_QAQC_Time.csv') # all data
...
# SIPEXII 2012
SIPEXII = pd.read_csv('/Users/ncp532/Documents/Data/SIPEXII_2012/SIPEXII_BrO_QAQC_Time.csv')
...
#------------------------------------
# V1_17
dat1 = np.array(V1_17_MM['Date'])
tim1 = np.array(V1_17_MM['Time'])
dattim1 = dat1+' '+tim1
...
#------------------------------------    
# V2_17
dat2 = np.array(V2_17_MM['Date'])
tim2 = np.array(V2_17_MM['Time'])
dattim2 = dat2+' '+tim2
...
#------------------------------------
# V3_17
dat3 = np.array(V3_17_MM['Date'])
tim3 = np.array(V3_17_MM['Time'])
dattim3 = dat3+' '+tim3
...
#------------------------------------
# V1_18
dat4 = np.array(V1_18_MM['Date'])
tim4 = np.array(V1_18_MM['Time'])
dattim4 = dat4+' '+tim4
...
#------------------------------------
# V2_18
dat5 = np.array(V2_18_MM['Date'])
tim5 = np.array(V2_18_MM['Time'])
dattim5 = dat5+' '+tim5
...
#------------------------------------
# V3_18
dat6 = np.array(V3_18_MM['Date'])
tim6 = np.array(V3_18_MM['Time'])
dattim6 = dat6+' '+tim6
...
#------------------------------------
# SIPEXII
dat7 = np.array(SIPEXII_MM['Date'])
tim7 = np.array(SIPEXII_MM['Time'])
dattim7 = dat7+' '+tim7
...
end_date = '2017-11-23'
Davis = (V1_17_MM['DateTime'] >= start_date) & (V1_17_MM['DateTime'] < end_date)
V1_17_Davis = V1_17_MM[Davis]
...
end_date2 = '2018-01-6'
Casey1 = (V2_17_MM['DateTime'] >= start_date1) & (V2_17_MM['DateTime'] < end_date1)
Casey2 = (V2_17_MM['DateTime'] >= start_date2) & (V2_17_MM['DateTime'] < end_date2)
V2_17_Casey1 = V2_17_MM[Casey1]
V2_17_Casey2 = V2_17_MM[Casey2]
V2_17_Casey = pd.concat([V2_17_Casey1,V2_17_Casey2], axis =0)

# V3_17 Mawson (1-17 Feb 2018)
start_date = '2018-02-01'
end_date = '2018-02-18'
Mawson = (V3_17_MM['DateTime'] >= start_date) & (V3_17_MM['DateTime'] < end_date)
V3_17_Mawson = V3_17_MM[Mawson]
...
end_date = '2018-11-16'
Davis = (V1_18_MM['DateTime'] >= start_date) & (V1_18_MM['DateTime'] < end_date)
V1_18_Davis = V1_18_MM[Davis]

# V2_18 Casey (15-30 Dec 2018)
start_date = '2018-12-15'
end_date = '2018-12-31'
Casey = (V2_18_MM['DateTime'] >= start_date) & (V2_18_MM['DateTime'] < end_date)
V2_18_Casey = V2_18_MM[Casey]

# V3_18 Mawson (30 Jan - 9 Feb 2019)
start_date = '2019-01-30'
end_date = '2019-02-10'
Mawson = (V3_18_MM['DateTime'] >= start_date) & (V3_18_MM['DateTime'] < end_date)
V3_18_Mawson = V3_18_MM[Mawson]
...
end_date = '2012-11-11'
SeaIce = (SIPEXII_MM['DateTime'] >= start_date) & (SIPEXII_MM['DateTime'] < end_date)
SIPEXII_Ice = SIPEXII_MM[SeaIce]
...
medianALL = (median2017+median2018)/2
...
# Plot the variables
ax.plot(date1_DMed, BrO_V1_17_DMed, marker='o', c='blue', markersize = 3.0, ls='-', label ='V1 (2017-18)\n median:'+str("%6.3f"%(median1)))
ax.plot(date1_DM, BrO_V1_17_DM, marker='o', c='black', markersize = 3.0, ls='-', label ='V1 (2017-18)\n mean:'+str("%6.3f"%(mean1)))
...
# Plot the variables
ax.plot(date2_DMed, BrO_V2_17_DMed, marker='o', c='blue', markersize = 3.0, ls='-', label ='V2 (2017-18)\n median:'+str("%6.3f"%(median2)))
ax.plot(date2_DM, BrO_V2_17_DM, marker='o', c='black', markersize = 3.0, ls='-', label ='V2 (2017-18)\n mean:'+str("%6.3f"%(mean2)))
...
# Format x-axis
plt.xlim(datetime(2017,12,21),datetime(2018,1,6)) # on station
plt.xticks(rotation=45)
xmajor_formatter = mdates.DateFormatter('%d %b') # format how the date is displayed
ax.xaxis.set_major_formatter(xmajor_formatter)
#xminor_formatter = mdates.DateFormatter('%d %b') # format how the date is displayed
...
#ax.set_xlabel('Date', fontsize=15)
#Plot the legend and title
plt.title('BrO Midday Mean vs Midday Median', fontsize=25, y=1.2)
#plt.legend(bbox_to_anchor=(1.05, 1), loc=2, borderaxespad=0.)
legend = ax.legend(loc='upper left')
legend.get_frame().set_facecolor('#00FFCC')
legend.get_frame().set_alpha(0.9)
...
# Plot the variables
ax.plot(date3_DMed, BrO_V3_17_DMed, marker='o', c='blue', markersize = 3.0, ls='-', label ='V3 (2017-18)\n median:'+str("%6.3f"%(median3)))
ax.plot(date3_DM, BrO_V3_17_DM, marker='o', c='black', markersize = 3.0, ls='-', label ='V3 (2017-18)\n mean:'+str("%6.3f"%(mean3)))
...
# Format x-axis
plt.xlim(datetime(2018,2,1),datetime(2018,2,18)) # on station
plt.xticks(rotation=45)
xmajor_formatter = mdates.DateFormatter('%d %b') # format how the date is displayed
ax.xaxis.set_major_formatter(xmajor_formatter)
#xminor_formatter = mdates.DateFormatter('%d %b') # format how the date is displayed
...
# Plot the variables
ax.plot(date4_DMed, BrO_V1_18_DMed, marker='o', c='red', markersize = 3.0, ls='-', label ='V1 (2018-19)\n median:'+str("%6.3f"%(median4)))
ax.plot(date4_DM, BrO_V1_18_DM, marker='o', c='black', markersize = 3.0, ls='-', label ='V1 (2018-19)\n mean:'+str("%6.3f"%(mean4)))
...
# Format x-axis
plt.xlim(datetime(2018,11,7),datetime(2018,11,16)) # on station
plt.xticks(rotation=45)
xmajor_formatter = mdates.DateFormatter('%d %b') # format how the date is displayed
ax.xaxis.set_major_formatter(xmajor_formatter)
#xminor_formatter = mdates.DateFormatter('%d %b') # format how the date is displayed
...
# Plot the variables
ax.plot(date5_DMed, BrO_V2_18_DMed, marker='o', c='red', markersize = 3.0, ls='-', label ='V2 (2018-19)\n median:'+str("%6.3f"%(median5)))
ax.plot(date5_DM, BrO_V2_18_DM, marker='o', c='black', markersize = 3.0, ls='-', label ='V2 (2018-19)\n mean:'+str("%6.3f"%(mean5)))
...
# Format x-axis
plt.xlim(datetime(2018,12,15),datetime(2018,12,31)) # on station
plt.xticks(rotation=45)
xmajor_formatter = mdates.DateFormatter('%d %b') # format how the date is displayed
ax.xaxis.set_major_formatter(xmajor_formatter)
#xminor_formatter = mdates.DateFormatter('%d %b') # format how the date is displayed
...
# Plot the variables
ax.plot(date6_DMed, BrO_V3_18_DMed, marker='o', c='red', markersize = 3.0, ls='-', label ='V3 (2018-19)\n median:'+str("%6.3f"%(median6)))
ax.plot(date6_DM, BrO_V3_18_DM, marker='o', c='black', markersize = 3.0, ls='-', label ='V3 (2018-19)\n mean:'+str("%6.3f"%(mean6)))
...
# Format x-axis
plt.xlim(datetime(2019,1,30),datetime(2019,2,10)) # on station
plt.xticks(rotation=45)
xmajor_formatter = mdates.DateFormatter('%d %b') # format how the date is displayed
ax.xaxis.set_major_formatter(xmajor_formatter)
#xminor_formatter = mdates.DateFormatter('%d %b') # format how the date is displayed
...
# Plot the variables
ax.plot(date7_DMed, BrO_SIPEXII_DMed, marker='o', c='green', markersize = 3.0, ls='-', label ='SIPEXII (2012)\n median:'+str("%6.3f"%(median7)))
ax.plot(date7_DM, BrO_SIPEXII_DM, marker='o', c='black', markersize = 3.0, ls='-', label ='SIPEXII (2012)\n mean:'+str("%6.3f"%(mean7)))
...
# Format x-axis
plt.xlim(datetime(2012,9,23),datetime(2012,11,11)) # on station
plt.xticks(rotation=45)
xmajor_formatter = mdates.DateFormatter('%d %b') # format how the date is displayed
ax.xaxis.set_major_formatter(xmajor_formatter)
#xminor_formatter = mdates.DateFormatter('%d %b') # format how the date is displayed
