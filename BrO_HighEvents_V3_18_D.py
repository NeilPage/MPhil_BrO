...
# BrO VMR
V1_2018 = pd.read_csv('/Users/ncp532/Documents/data/V1_17_APriori/V3_18/all_BrO/V3_18_BrO_VMR.csv', index_col=0) # BrO data for CAMPCANN V1 (2018/19)

# BrO Error
V1_Error = pd.read_csv('/Users/ncp532/Documents/data/V1_17_APriori/V3_18/BrO_error/V3_18_BrO_error.csv', index_col=0) # BrO error data for CAMPCANN V1 (2018/19)
...
# NO2 VMR
NO2 = pd.read_csv('/Users/ncp532/Documents/data/V1_17_APriori/V3_18/all_NO2/V3_18_NO2_VMR.csv',index_col=0) # NO2 data for CAMPCANN V1 (2018/19)

# NO2 Error
NO2_Error = pd.read_csv('/Users/ncp532/Documents/data/V1_17_APriori/V3_18/NO2_error/V3_18_NO2_error.csv', index_col=0) # NO2 error data for CAMPCANN V1 (2018/19)
...
AeroExt_338 = pd.read_csv('/Users/ncp532/Documents/data/V1_17_APriori/V3_18/all_Aerosol/V3_18_AeroExt_338.csv',index_col=0) # Aerosol extinction data at 338 nm for CAMPCANN V1 (2017/18)

# Aerosol extinction at 375 nm (NO2)
#AeroExt_375 = pd.read_csv('/Users/ncp532/Documents/data/V1_17_APriori/V3_18/all_Aerosol/V3_18_AeroExt_375.csv',index_col=0) # Aerosol extinction data at 375 nm for CAMPCANN V1 (2017/18)

# Aerosol extinction wl at 360 nm
AeroExt_360 = pd.read_csv('/Users/ncp532/Documents/data/V1_17_APriori/V3_18/all_Aerosol/V3_18_AeroExt_wl_360.csv',index_col=0) # Aerosol extinction data at 360 nm for CAMPCANN V1 (2017/18)
...
# BrO AOD
BrO_AOD = pd.read_csv('/Users/ncp532/Documents/data/V1_17_APriori/V3_18/all_AOD/V3_18_AOD_338.csv',index_col=0) # AOD data for CAMMPCAN V1 (2018/19)

# NO2_AOD
NO2_AOD = pd.read_csv('/Users/ncp532/Documents/data/V1_17_APriori/V3_18/all_AOD/V3_18_AOD_375.csv',index_col=0) # AOD data for CAMMPCAN V1 (2018/19)

#---------
# SZA
#---------

DF4_SZA = pd.read_csv('/Users/ncp532/Documents/data/V1_17_APriori/V3_18/all_SZA/V3_18_SZA.csv',index_col=0) # SZA data for CAMPCANN V1 (2018/19)

#---------
# MET
#---------

SIPEXII_Met = pd.read_csv('/Users/ncp532/Documents/Data/CAMMPCAN_2018_19/V03/CAMMPCAN_V3_underway_60.csv', index_col=0) #SIPEXII_underway_60.csv') 

#---------
# O3
#---------

SIPEXII_O3  = pd.read_csv('/Users/ncp532/Documents/Data/CAMMPCAN_2018_19/O3/V3_O3_1min.csv')

#---------
# HYSPLIT
#---------

HYSPLIT_E20 = mpimg.imread('/Users/ncp532/Desktop/Graphs/HYSPLIT/Event20_20190125.gif')
...
# Event 20 (25 Jan 2019)
start_date = '2019-01-25'
end_date   = '2019-01-26'
Event20    = (SIPEXIITT.index >= start_date) & (SIPEXIITT.index < end_date)
Event20M   = SIPEXIITT[Event20]

# Transpose the dataframes back again
Event20TT = Event20M.T

#------------------------------------------------------------------------------
# Calculate the mean/StDev and median/MAD BrO VCD for each altitude 

# Event 20
Mean_Event20   = np.mean(Event20TT, axis=1) * 1e6
Median_Event20 = np.median(Event20TT, axis=1) * 1e6
StDev_Event20  = np.std(Event20TT, axis=1) * 1e6
MAD_Event20    = Event20TT.mad(axis=1, skipna='True') * 1e6
MAX_Event20    = np.max(Event20TT, axis=1) * 1e6

#------------------------------------------------------------------------------
# PLOT EVENT 20 (25 January 2019)
#------------------------------------------------------------------------------

fig = plt.figure(figsize=(10,6))
fig.suptitle('25 January 2019', fontsize=20, y=0.95)
...
# Format x-axis
plt.xlim(datetime(2019,1,25,0,0,0),datetime(2019,1,25,23,59,59))
...
ax.errorbar(MAX_Event20, MAX_Event20.index,   marker='o', c='black',  markersize = 3.0, ls='-', label ='Max BrO: 25.3 $\pm$ 4.0 pptv',   xerr=StDev_Event20,   capsize=2)
...
ax3.yaxis.set_major_locator(ticker.MultipleLocator(10))
ax3.yaxis.set_minor_locator(ticker.MultipleLocator(5))
ax3.set_ylim(40,104) # On Station
